...
export const treatmentsListBody = () => {
  const newFragment = $(
    `<div class='allcards'><div class="card-group-body"></div></div>`
  );
...
export const treatmentsListFace = () => {
  const newFragment = $(
    `<div class='allcards'><div class="card-group-face"></div></div>`
  );
  ...
  treatmentsService
    ...
    .then((treatmentsItem) =>
      newFragment.find(".card-group-face").append(treatmentsItem)
    );
  return newFragment;
};
...
export const treatmentsListHAL = () => {
  const newFragment = $(
    `<div class='allcards'><div class="card-group-hal"></div></div>`
  );
  ...
  treatmentsService
    ...
    .then((treatmentsItem) =>
      newFragment.find(".card-group-hal").append(treatmentsItem)
    );
  return newFragment;
};
